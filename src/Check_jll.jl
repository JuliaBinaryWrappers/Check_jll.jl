...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Check_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("491db154-c145-5abe-9c32-446728d60cce"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Check", artifacts_toml) for e in artifacts["Check"]]
...
if best_platform === nothing
    @debug("Unable to load Check; unsupported platform $(triplet(platform_key_abi()))")
else
